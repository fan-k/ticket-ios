...
#define MainColor [UIColor colorWithRed:192/255.0 green:192/255.0 blue:192/255.0 alpha:1]


@interface FanRefreshHeader ()
...
@implementation FanRefreshHeader
...
- (void)prepare
{
    ...
    imgView.image = [UIImage imageNamed:@"RefreshIcon"];
    ...
    moveView.backgroundColor=MainColor;
...
-(void)updateFrame{
    ...
    if (self.imgView.hidden==NO) {
        ...
        if (_shapeLayer==nil) {
            ...
            _shapeLayer.fillColor=MainColor.CGColor;
