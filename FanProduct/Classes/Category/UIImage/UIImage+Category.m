...
+ (CGSize)getImageSizeWithUrl:(NSString *)imageUrl{
    ...
    {
        NSData* data = [NSData getImgWithUrl:imageUrl];
...
+ (NSData *)getImgWithUrl:(NSString *)urlStr{
    if ([urlStr isNotBlank]) {
        ...
        NSString *path = [NSHomeDirectory() stringByAppendingString:[NSString stringWithFormat:@"/Documents/Library/Caches/%@",urlStr]];
